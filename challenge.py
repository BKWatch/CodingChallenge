...
XML_TAGS = ['ENTITY', 'ENT', 'NAME', 'COMPANY', 'STREET',
            'STREET_2', 'STREET_3', 'CITY', 'STATE', 'POSTAL_CODE', 'COUNTRY']
TSV_COLUMNS = ['first', 'middle', 'last', 'organization',
...
def validate_zip(zip: str) -> bool:
    '''
    Validate zip follows the right format. Either 00000 or 00000-0000.
    '''
...
def validate_address(address: dict) -> bool:
    '''
    Validates all the fields in the address.
    '''
...
def validate_xml_tags(tree: ElementTree) -> bool:
    '''
    Check whether all the tags in the input file matches with the expected tags.
    '''
